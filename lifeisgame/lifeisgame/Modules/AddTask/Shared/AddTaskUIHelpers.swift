...
enum AddTaskUIHelpers {
    ...
    static func makeFieldBlock(header: UILabel, field: UIView) -> UIView {
        let card = UIView()
        Self.styleCard(card)
    ...
    static func makeDateCard(icon iconName: String, title: String, picker: UIDatePicker) -> UIView {
        let card = UIView()
        Self.styleCard(card)
    ...
    static func makeSliderBlock(header: UILabel, valueLabel: UILabel, slider: UISlider) -> UIView {
        let card = UIView()
        Self.styleCard(card)
        card.addSubview(header)
